...
#### Packages utilisées
Tout d'abord, nous devons installer des 3 packages comme ci-dessous ;  
```{r eval=FALSE}
...
1. Dans le cas de **tibble**, nous pouvons manipuler des data frames.
   Nous pouvons le travailler sur le site suivant ;    
     https://cran.r-project.org/web/packages/tibble/vignettes/tibble.html
2. Dans le cas de **ggplot2**, nous pouvons produire un graphie à partir de données.
   Nous pouvons le travailler sur le site suviant ;
...
- Je me le suis référé sur le site : http://rfunction.com/archives/62 
